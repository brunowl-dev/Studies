...
Atividades feitas durante o curso de **Análise e Desenvolvimento de Sistemas** na Fatec Baixada Santista, organizadas por semestre.

## Semestres

| Semestre | Foco | Linguagem(s) |
|---|---|---|
| [`semestre-1/`](./semestre-1) | Lógica de programação e algoritmos | C |
